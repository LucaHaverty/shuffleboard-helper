...
public class ShuffleboardHelper {
    ...
    public static class ShuffleboardOutput extends ShuffleboardObject {
        ...
        public ShuffleboardOutput withPos(int x, int y) {
    ...
    public static void addMotorInfo(String name, ShuffleboardTab tab, CANSparkMax motor, int x, int y) {
        ...
        addOutput("Encoder Position", layout, () -> motor.getEncoder().getPosition()).withPos(0, 1);
        addOutput("Encoder Velocity", layout, () -> motor.getEncoder().getVelocity()).withPos(0, 2);
        addOutput("Temperature", layout, () -> motor.getMotorTemperature()).withPos(0, 3);
        addOutput("Motor Output (Amps)", layout, () -> motor.getOutputCurrent()).withPos(0, 4);
    }
